...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/keyguard/SlidingChallengeLayout$1;,
        Lcom/android/keyguard/SlidingChallengeLayout$2;,
        Lcom/android/keyguard/SlidingChallengeLayout$3;,
        Lcom/android/keyguard/SlidingChallengeLayout$4;,
        Lcom/android/keyguard/SlidingChallengeLayout$5;,
        Lcom/android/keyguard/SlidingChallengeLayout$6;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/keyguard/SlidingChallengeLayout;)Landroid/view/View;
    .locals 1
...
.method static synthetic -wrap0(Lcom/android/keyguard/SlidingChallengeLayout;Z)V
    .locals 0
    .param p1, "show"    # Z
...
.method static synthetic -wrap1(Lcom/android/keyguard/SlidingChallengeLayout;Z)V
    .locals 0
    .param p1, "show"    # Z
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "handleAlpha"
...
.method private crossedDragHandle(FFF)Z
    ...
    .prologue
    .line 778
    iget-object v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeView:Lcom/android/keyguard/KeyguardSecurityContainer;

    invoke-virtual {v3}, Lcom/android/keyguard/KeyguardSecurityContainer;->getTop()I
    ...
    .local v1, "horizOk":Z
    :goto_0
    iget-boolean v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeShowing:Z
...
.method private isChallengeInteractionBlocked()Z
    ...
    .line 613
    iget-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeInteractiveExternal:Z

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeInteractiveInternal:Z
...
.method private isEdgeSwipeBeginEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v4, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragHandleEdgeSlop:I
...
.method private moveChallengeTo(I)Z
    ...
    iget-boolean v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mHasLayout:Z
    ...
    invoke-virtual {v3}, Lcom/android/keyguard/KeyguardSecurityContainer;->getHeight()I
    ...
    .line 1148
    iget v4, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mChallengeBottomBound:I
    ...
    invoke-virtual {v4}, Lcom/android/keyguard/KeyguardSecurityContainer;->getLeft()I
    ...
    invoke-virtual {v5}, Lcom/android/keyguard/KeyguardSecurityContainer;->getHeight()I
    ...
    invoke-virtual {v6}, Lcom/android/keyguard/KeyguardSecurityContainer;->getRight()I

    move-result v6

    .line 1154
    invoke-virtual {v3, v4, v5, v6, p1}, Lcom/android/keyguard/KeyguardSecurityContainer;->layout(IIII)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/keyguard/KeyguardSecurityContainer;->setAlpha(F)V

    .line 1158
    iget-object v3, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mScrollListener:Lcom/android/keyguard/SlidingChallengeLayout$OnChallengeScrolledListener;
    ...
    invoke-virtual {v4}, Lcom/android/keyguard/KeyguardSecurityContainer;->getTop()I

    move-result v4

    invoke-interface {v3, v2, v4}, Lcom/android/keyguard/SlidingChallengeLayout$OnChallengeScrolledListener;->onScrollPositionChanged(FI)V
    ...
    .line 1138
    .end local v0    # "challengeHeight":I
    .end local v1    # "layoutBottom":I
    ...
    .line 1151
    .restart local v0    # "challengeHeight":I
    .restart local v1    # "layoutBottom":I
    .restart local v2    # "offset":F
    :cond_3
    invoke-direct {p0, v7}, Lcom/android/keyguard/SlidingChallengeLayout;->setChallengeShowing(Z)V
...
.method private resetTouch()V
    ...
    .line 620
    iput-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mBlockDrag:Z

    iput-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mDragging:Z
...
.method private sendInitialListenerUpdates()V
    ...
    .restart local v0    # "challengeTop":I
    goto :goto_0
.end method
...
.method private shouldEnableChallengeDragging()Z
    ...
    .line 609
    iget-boolean v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mEnableChallengeDragging:Z
...
.method private showChallenge(I)V
    ...
    iget v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mMinVelocity:I
...
.method animateHandle(Z)V
    ...
    .line 291
    iput-object v2, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mHandleAnimation:Landroid/animation/ObjectAnimator;
...
.method public computeScroll()V
    ...
    .line 1022
    const-string/jumbo v0, "SlidingChallengeLayout"

    const-string/jumbo v1, "Challenge view missing in computeScroll"
...
.method protected onMeasure(II)V
    ...
    .line 817
    const-string/jumbo v3, "SlidingChallengeLayout must be measured with an exact size"
    ...
    .line 841
    const-string/jumbo v3, "There may only be one child with layout_isChallenge=\"true\""
    ...
    .line 860
    const-string/jumbo v3, "There may only be one child with layout_childType=\"expandChallengeHandle\""
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v8, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mMaxVelocity:I
...
.method setScrollState(I)V
    ...
    .line 358
    iget v1, p0, Lcom/android/keyguard/SlidingChallengeLayout;->mScrollState:I
