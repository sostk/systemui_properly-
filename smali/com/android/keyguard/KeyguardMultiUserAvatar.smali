...
# direct methods
.method static synthetic -get0(Lcom/android/keyguard/KeyguardMultiUserAvatar;)Lcom/android/keyguard/KeyguardCircleFramedDrawable;
    .locals 1
...
.method static synthetic -get1(Lcom/android/keyguard/KeyguardMultiUserAvatar;)Landroid/widget/ImageView;
    .locals 1
...
.method static synthetic -get2(Lcom/android/keyguard/KeyguardMultiUserAvatar;)Landroid/widget/TextView;
    .locals 1
...
.method updateVisualsForActive(ZZILjava/lang/Runnable;)V
    ...
    iget v7, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mActiveAlpha:F
    ...
    iget v6, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mInactiveAlpha:F

    .line 178
    .local v6, "initAlpha":F
    :goto_1
    if-eqz p1, :cond_3
    ...
    invoke-virtual {v2}, Lcom/android/keyguard/KeyguardCircleFramedDrawable;->getScale()F

    move-result v4

    .line 180
    .local v4, "initScale":F
    if-eqz p1, :cond_4

    iget v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mActiveTextAlpha:F
    ...
    .line 182
    .local v9, "finalTextAlpha":I
    :goto_3
    if-eqz p1, :cond_5

    iget v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mInactiveTextAlpha:F
    ...
    .line 184
    .local v8, "initTextAlpha":I
    :goto_4
    iget v10, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mTextColor:I
    ...
    iget-boolean v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mTouched:Z
    ...
    new-instance v2, Lcom/android/keyguard/KeyguardMultiUserAvatar$1;

    move-object v3, p0

    invoke-direct/range {v2 .. v9}, Lcom/android/keyguard/KeyguardMultiUserAvatar$1;-><init>(Lcom/android/keyguard/KeyguardMultiUserAvatar;FFFFII)V
    ...
    .line 202
    new-instance v2, Lcom/android/keyguard/KeyguardMultiUserAvatar$2;

    move-object/from16 v0, p4

    invoke-direct {v2, p0, v0}, Lcom/android/keyguard/KeyguardMultiUserAvatar$2;-><init>(Lcom/android/keyguard/KeyguardMultiUserAvatar;Ljava/lang/Runnable;)V
    ...
    iput-boolean v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mTouched:Z

    .line 175
    return-void

    .line 176
    .end local v4    # "initScale":F
    .end local v5    # "finalScale":F
    .end local v6    # "initAlpha":F
    .end local v7    # "finalAlpha":F
    .end local v8    # "initTextAlpha":I
    .end local v9    # "finalTextAlpha":I
    .end local v10    # "textColor":I
    :cond_1
    iget v7, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mInactiveAlpha:F

    .restart local v7    # "finalAlpha":F
    goto :goto_0

    .line 177
    :cond_2
    iget v6, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mActiveAlpha:F

    .restart local v6    # "initAlpha":F
    goto :goto_1

    .line 178
    :cond_3
    iget v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mActiveScale:F

    const/high16 v3, 0x3f800000    # 1.0f

    div-float v5, v3, v2

    .restart local v5    # "finalScale":F
    goto :goto_2

    .line 181
    .restart local v4    # "initScale":F
    :cond_4
    iget v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mInactiveTextAlpha:F
    ...
    .restart local v9    # "finalTextAlpha":I
    goto :goto_3
    ...
    .restart local v8    # "initTextAlpha":I
    goto :goto_4
    ...
    invoke-virtual {v2, v5}, Lcom/android/keyguard/KeyguardCircleFramedDrawable;->setScale(F)V

    .line 214
    iget-object v2, p0, Lcom/android/keyguard/KeyguardMultiUserAvatar;->mUserImage:Landroid/widget/ImageView;
    ...
    invoke-static {v9, v3, v12, v13}, Landroid/graphics/Color;->argb(IIII)I
    ...
    invoke-virtual {p0, v0}, Lcom/android/keyguard/KeyguardMultiUserAvatar;->post(Ljava/lang/Runnable;)Z
